...
- **Server IP Address:** 68.183.67.6
- **Server Alias:** http://68.183.67.6.xip.io/
- **SSH server access port:** 2200
- **SSH login username:** grader
- **Application URL:** http://68.183.67.6.xip.io/
...
**Note**: Above, the UNIX password I have entered for the user `grader` is, `2684`.
...
6. After you are back to the host machine, when you try to log in as `root`, you should get an error:
   ...
   ```console
   $ ssh root@68.183.67.6 -p 2200
   root@68.183.67.6: Permission denied (publickey).
   ```
...
To confirm whether it successfully installed or not, enter the URL `http://68.183.67.6` in your Web browser:
...
```
<VirtualHost *:80>
   ServerName 68.183.67.6
   ServerAlias 68.183.67.6.xip.io
   ServerAdmin grader@68.183.67.6
...
11. Restart Apache server:
   ...
   Now you should be able to run the application at <http://68.183.67.6.xip.io/>.
...
7. Authorized JavaScript origins = 'http://68.183.67.6.xip.io'
8. Authorized redirect URIs = 'http://68.183.67.6.xip.io/login' && 'http://68.183.67.6.xip.io/gconnect'
9. Select Create
